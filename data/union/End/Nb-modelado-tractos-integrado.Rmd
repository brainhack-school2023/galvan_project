...
Al trabajar solo con el features A, vamos a reducir con PCA las predictoras.

```{r}
### Son sujetos de estudio los seleccionados
...
### Son sujetos de control los seleccionados
...
### FORMA 2 Reg Logística con PCA para Sujetos de Estudio
...
prop_varianza <- pca.out2$sdev^2/sum(pca.out2$sdev^2)
...
### Reg Logística con PCA para Sujetos de Control
